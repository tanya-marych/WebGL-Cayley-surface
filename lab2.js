...
function main() {
  ...
  const texture = loadTexture(gl, background);
  ...
  function render(now) {
    ...
    drawScene(gl, programInfo, buffers, texture, deltaTime, vertexCount);
...
function initBuffers(gl) {
  ...
  const textureCoordinates = getTextureCoordinates(faces);
